...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.ContentInteraction"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/content-interactions/{content_id}/stats": {
            "get": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.InteractionStats"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/content-interactions/{content_id}/user-status": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.UserInteractionStatus"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/content-interactions/{content_id}/{interaction_type}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "dto.CreateInteractionRequest": {
            ...
            "properties": {
                ...
                "interaction_type": {
                    "description": "like, dislike, bookmark, share",
                    "type": "string",
                    "example": "like"
                }
            }
