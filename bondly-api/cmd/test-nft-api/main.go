...
func main() {
	fmt.Println("🧪 Testing NFT API update functionality...")
	...
	fmt.Println("📝 Now the backend API should be able to handle NFT updates properly!")

	// 测试JSON序列化
	fmt.Println("\n🔍 Testing JSON serialization...")
	jsonData, err := json.Marshal(updatedContent)
	if err != nil {
