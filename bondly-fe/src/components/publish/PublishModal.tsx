      ...
      <div style={modalStyle} onClick={(e) => e.stopPropagation()}>
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              setPublishData((prev) => ({ ...prev, summary: e.target.value }))
            }
            style={textareaStyle}
            placeholder="请输入文章摘要..."
          />
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setPublishData((prev) => ({ ...prev, category: e.target.value }))
            }
            style={selectStyle}
          >
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setPublishData((prev) => ({ ...prev, language: e.target.value }))
            }
            style={selectStyle}
          >
            {languages.map((lang) => (
